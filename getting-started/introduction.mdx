---
title: "Getting Started with GetMonitor"
...
![Login Page](/images/product/console.getmonitor.io_en-US_login.png)
...
![Onboarding Flow](/images/product/console.getmonitor.io_en-US_onboarding.png)
...
![Dashboard](/images/product/console.getmonitor.io_en-US_org_fvd0bqahqfj5nnf2d4m5n373_dashboard_full.png)
...
<CardGroup cols={2}>
  <Card title="Create Monitors" icon="chart-line" href="/monitoring/creating-monitors">
  ...
  <Card title="Configure Alerts" icon="bell" href="/notifications/alert-rules">
    Set up notifications for incidents
  </Card>
  <Card title="Invite Team Members" icon="users" href="/organization/team-members">
