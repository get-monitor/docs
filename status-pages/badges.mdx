...
![Badge Settings](/images/product/console.getmonitor.io_en-US_status-page_c1rui6avx08bx20fr3bne9vy_settings_tab=badge.png)
...
<CardGroup cols={2}>
  ...
  <Card title="Components" icon="layer-group" href="/status-pages/components">
    Configure what services show on your status page
  </Card>
  <Card title="Incidents" icon="triangle-exclamation" href="/incidents-maintenance/incidents">
    Manage incidents that affect badge status
  </Card>
  <Card title="Status Page Overview" icon="browser" href="/status-pages/overview">
