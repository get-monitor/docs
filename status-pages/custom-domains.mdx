...
![Domain Configuration](/images/product/console.getmonitor.io_en-US_status-page_c1rui6avx08bx20fr3bne9vy_settings?tab=domain.png)
...
<CardGroup cols={2}>
  ...
  <Card title="Customize Branding" icon="palette" href="/status-pages/overview">
