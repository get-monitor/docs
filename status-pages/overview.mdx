...
![Status Pages List](/images/product/console.getmonitor.io_en-US_org_fvd0bqahqfj5nnf2d4m5n373_status-pages.png)
...
![Status Page Dashboard](/images/product/console.getmonitor.io_en-US_status-page_c1rui6avx08bx20fr3bne9vy_dashboard.png)
...
<Card title="Customize Your Status Page" icon="palette" href="/status-pages/components">
...
<CardGroup cols={2}>
  <Card title="Add Components" icon="layer-group" href="/status-pages/components">
    Organize monitors into logical groups
  </Card>
  <Card title="Custom Domain" icon="globe" href="/status-pages/custom-domains">
