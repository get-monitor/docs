...
![Components Selection](/images/product/console.getmonitor.io_en-US_status-page_c1rui6avx08bx20fr3bne9vy_components.png)
...
- **Monitor Name** - The name of your monitor (e.g., "Monitor Checks", "getmonitor.io")
