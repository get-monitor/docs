...
GetMonitor lets you attach notification channels directly to a monitor. Each integration type has a slightly different setup form depending on the destination, credential, or endpoint it needs.

## Email

Email integrations send alerts to a single inbox for the selected monitor.

![Email integration form](/images/product/console.getmonitor.io_en-US_org_fvd0bqahqfj5nnf2d4m5n373_monitors_jpbbnit76o9gx6ifthw5oxld_alerts_new_email.png)
...
![SMS integration form](/images/product/console.getmonitor.io_en-US_org_fvd0bqahqfj5nnf2d4m5n373_monitors_jpbbnit76o9gx6ifthw5oxld_alerts_new_sms.png)
...
![Slack integration form](/images/product/console.getmonitor.io_en-US_org_fvd0bqahqfj5nnf2d4m5n373_monitors_jpbbnit76o9gx6ifthw5oxld_alerts_new_slack.png)
...
2. Open the monitor's Alerts screen in GetMonitor.
...
![Discord integration form](/images/product/console.getmonitor.io_en-US_org_fvd0bqahqfj5nnf2d4m5n373_monitors_jpbbnit76o9gx6ifthw5oxld_alerts_new_discord.png)
...
![Telegram integration form](/images/product/console.getmonitor.io_en-US_org_fvd0bqahqfj5nnf2d4m5n373_monitors_jpbbnit76o9gx6ifthw5oxld_alerts_new_telegram.png)
...
![Webhook integration form](/images/product/console.getmonitor.io_en-US_org_fvd0bqahqfj5nnf2d4m5n373_monitors_jpbbnit76o9gx6ifthw5oxld_alerts_new_webhook.png)
...
This is the exact JSON payload shape GetMonitor sends today:
