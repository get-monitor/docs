...
![Monitor Statistics](/images/product/console.getmonitor.io_en-US_org_fvd0bqahqfj5nnf2d4m5n373_monitors_h57gelnp2cn3es7jg4x3vwp6_statistics.png)
...
<CardGroup cols={2}>
  ...
  <Card title="Create Status Page" icon="browser" href="/status-pages/overview">
  ...
  <Card title="Alert Rules" icon="triangle-exclamation" href="/notifications/alert-rules">
